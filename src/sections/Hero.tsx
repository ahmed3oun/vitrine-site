...
function Hero() {
  ...
  return (
    ...
    >
      ...
      justify-start items-start w-full max-xl:padding-x pt-28"
      >
        ...
        <p
          className="font-montserrat text-slate-gray text-lg leading-8 mb-14 mt-6 
        sm:max-w-sm
        "
        >
      ...
      <div className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        ...
        />
        <div className="flex sm:gap-6 gap-4 z-20 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6">
